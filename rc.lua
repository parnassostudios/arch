...
mytemp = lain.widgets.temp({
    settings = function()
      widget:set_markup("TEM: <span color='" .. hlcolor .. "'>" .. coretemp_now .. "%</span> | ")
    end
})
-- cpu widget
mycpu = lain.widgets.cpu({
    settings = function()
      widget:set_markup("CPU: <span color='" .. hlcolor .. "'>" .. cpu_now.usage .. "%</span> | ")
    end
})
-- memory widget
memwidget = wibox.widget.textbox()
vicious.register(memwidget, vicious.widgets.mem, "MEM: <span color='" .. hlcolor .. "'>$1%($2MB/$3MB)</span> | ",23)
-- battery widget
